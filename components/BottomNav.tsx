...
export default function BottomNav({
  ...
  return (
    <nav
      className="md:hidden fixed bottom-0 inset-x-0 z-20 border-t border-neutral-200 bg-white/95 backdrop-blur pb-[env(safe-area-inset-bottom)]"
      aria-label="Primary"
    >
          ...
          return (
            <Link
              ...
              className={`relative flex flex-1 flex-col items-center justify-center gap-1 py-2 text-[11px] transition-colors ${
                active ? "text-brand-pink" : "text-[#c7c7cc] hover:text-neutral-400"
              }`}
            >
